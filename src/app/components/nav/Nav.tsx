  ...
  return (
    <div className="h-[13vh] bg-[#181a1d]">
      <div className="flex items-center justify-between w-[90%] xl:w-[80%] h-full mx-auto">
        <div className="text-[20px] sm:text-[25px] md:text-[27px] lg:text-[30px]  font-semibold text-white">
          Brit<span className="text-[#E487FF]">sols</span>.
        ...
        <div className="flex items-center space-x-6">
          <Link href="#">
            <button className="relative h-8 sm:h-10 w-[100px] sm:w-[120px] overflow-hidden rounded-full bg-[#E487FF] text-lg shadow group">
